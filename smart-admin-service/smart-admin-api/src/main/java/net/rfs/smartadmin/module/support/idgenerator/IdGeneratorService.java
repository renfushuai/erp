...
import net.rfs.smartadmin.module.support.idgenerator.constant.IdGeneratorEnum;
import net.rfs.smartadmin.module.support.idgenerator.constant.IdGeneratorRuleTypeEnum;
import net.rfs.smartadmin.module.support.idgenerator.domain.IdGeneratorEntity;
import net.rfs.smartadmin.module.support.idgenerator.domain.IdGeneratorPOJO;
