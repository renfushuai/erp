package net.rfs.smartadmin.module.system.role.basic;

import net.rfs.smartadmin.common.domain.ResponseDTO;
import net.rfs.smartadmin.module.system.role.basic.domain.dto.RoleAddDTO;
import net.rfs.smartadmin.module.system.role.basic.domain.dto.RoleUpdateDTO;
import net.rfs.smartadmin.module.system.role.basic.domain.dto.RoleVO;
