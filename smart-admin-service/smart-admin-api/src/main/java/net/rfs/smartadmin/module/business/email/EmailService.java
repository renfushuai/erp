package net.rfs.smartadmin.module.business.email;
...
import net.rfs.smartadmin.module.business.email.domain.dto.EmailConfigDTO;
import net.rfs.smartadmin.module.business.email.domain.dto.EmailDTO;
import net.rfs.smartadmin.module.business.email.domain.dto.EmailQueryDTO;
import net.rfs.smartadmin.module.business.email.domain.dto.EmailVO;
import net.rfs.smartadmin.module.business.email.domain.entity.EmailEntity;
...
import net.rfs.smartadmin.util.SmartSendMailUtil;
