package net.rfs.smartadmin.common.constant;

import net.rfs.smartadmin.module.system.department.DepartmentResponseCodeConst;
import net.rfs.smartadmin.module.system.employee.constant.EmployeeResponseCodeConst;
import net.rfs.smartadmin.module.support.file.constant.FileResponseCodeConst;
import net.rfs.smartadmin.module.business.log.orderoperatelog.constant.OrderOperateLogOperateTypeConst;
import net.rfs.smartadmin.module.system.login.LoginResponseCodeConst;
import net.rfs.smartadmin.module.system.position.PositionResponseCodeConst;
import net.rfs.smartadmin.module.system.privilege.constant.PrivilegeResponseCodeConst;
import net.rfs.smartadmin.module.system.role.basic.RoleResponseCodeConst;
import net.rfs.smartadmin.module.system.systemconfig.constant.SystemConfigResponseCodeConst;
