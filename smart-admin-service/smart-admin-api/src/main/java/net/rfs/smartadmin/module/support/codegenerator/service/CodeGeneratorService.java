package net.rfs.smartadmin.module.support.codegenerator.service;

import com.google.common.base.CaseFormat;
import net.rfs.smartadmin.module.support.codegenerator.dao.TableDao;
...
import net.rfs.smartadmin.module.support.codegenerator.domain.ColumnVO;
import net.rfs.smartadmin.module.support.codegenerator.domain.QueryFieldVO;
import net.rfs.smartadmin.util.SmartDateUtil;
...
public class CodeGeneratorService {
    ...
    public void codeGenerator(CodeGeneratorDTO codeGenerator) throws Exception {
        ...
        if (StringUtils.isEmpty(basePackage)) {
            basePackage = "net.rfs.smartadmin";
        }
