package net.rfs.smartadmin.module.system.department;

import net.rfs.smartadmin.common.domain.ResponseDTO;
import net.rfs.smartadmin.module.system.department.domain.dto.DepartmentCreateDTO;
import net.rfs.smartadmin.module.system.department.domain.dto.DepartmentUpdateDTO;
import net.rfs.smartadmin.module.system.department.domain.dto.DepartmentVO;
