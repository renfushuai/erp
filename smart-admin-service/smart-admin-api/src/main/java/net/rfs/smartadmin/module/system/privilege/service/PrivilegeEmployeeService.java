package net.rfs.smartadmin.module.system.privilege.service;

import net.rfs.smartadmin.common.constant.JudgeEnum;
import net.rfs.smartadmin.common.exception.SmartBusinessException;
...
import net.rfs.smartadmin.module.system.privilege.constant.PrivilegeTypeEnum;
...
import net.rfs.smartadmin.module.system.role.roleprivilege.RolePrivilegeDao;
import net.rfs.smartadmin.module.system.systemconfig.SystemConfigService;
import net.rfs.smartadmin.module.system.systemconfig.constant.SystemConfigEnum;
import net.rfs.smartadmin.module.system.systemconfig.domain.dto.SystemConfigDTO;
