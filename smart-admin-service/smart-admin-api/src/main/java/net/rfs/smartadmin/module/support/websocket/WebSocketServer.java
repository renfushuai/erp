package net.rfs.smartadmin.module.support.websocket;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.TypeReference;
import net.rfs.smartadmin.module.support.websocket.domain.MessageCommonDTO;
import net.rfs.smartadmin.module.support.websocket.domain.MessageDTO;
import net.rfs.smartadmin.module.support.websocket.domain.WebSocketHeartBeatDTO;
