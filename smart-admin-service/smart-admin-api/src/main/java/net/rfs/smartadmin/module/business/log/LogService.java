package net.rfs.smartadmin.module.business.log;

import net.rfs.smartadmin.module.business.log.orderoperatelog.OrderOperateLogDao;
import net.rfs.smartadmin.module.business.log.orderoperatelog.domain.entity.OrderOperateLogEntity;
import net.rfs.smartadmin.module.business.log.userloginlog.UserLoginLogDao;
import net.rfs.smartadmin.module.business.log.userloginlog.domain.UserLoginLogEntity;
import net.rfs.smartadmin.module.business.log.useroperatelog.UserOperateLogDao;
import net.rfs.smartadmin.module.business.log.useroperatelog.domain.UserOperateLogEntity;
import net.rfs.smartadmin.util.SmartThreadFactory;
