package net.rfs.smartadmin.module.business.log.useroperatelog;

import com.baomidou.mybatisplus.extension.plugins.pagination.Page;
import net.rfs.smartadmin.common.domain.PageResultDTO;
import net.rfs.smartadmin.common.domain.ResponseDTO;
import net.rfs.smartadmin.module.business.log.useroperatelog.domain.UserOperateLogDTO;
import net.rfs.smartadmin.module.business.log.useroperatelog.domain.UserOperateLogEntity;
import net.rfs.smartadmin.module.business.log.useroperatelog.domain.UserOperateLogQueryDTO;
