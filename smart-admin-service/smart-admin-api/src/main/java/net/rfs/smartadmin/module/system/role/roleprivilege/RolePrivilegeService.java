package net.rfs.smartadmin.module.system.role.roleprivilege;

import net.rfs.smartadmin.common.domain.ResponseDTO;
import net.rfs.smartadmin.module.system.privilege.dao.PrivilegeDao;
...
import net.rfs.smartadmin.module.system.role.basic.RoleDao;
import net.rfs.smartadmin.module.system.role.basic.RoleResponseCodeConst;
import net.rfs.smartadmin.module.system.role.basic.domain.entity.RoleEntity;
import net.rfs.smartadmin.module.system.role.roleprivilege.domain.dto.RolePrivilegeDTO;
import net.rfs.smartadmin.module.system.role.roleprivilege.domain.dto.RolePrivilegeSimpleDTO;
import net.rfs.smartadmin.module.system.role.roleprivilege.domain.dto.RolePrivilegeTreeVO;
import net.rfs.smartadmin.module.system.role.roleprivilege.domain.entity.RolePrivilegeEntity;
