package net.rfs.smartadmin.module.system.datascope.service;

import com.google.common.collect.Lists;
import net.rfs.smartadmin.module.system.datascope.DataScopeRoleDao;
import net.rfs.smartadmin.module.system.datascope.constant.DataScopeTypeEnum;
import net.rfs.smartadmin.module.system.datascope.constant.DataScopeViewTypeEnum;
import net.rfs.smartadmin.module.system.datascope.domain.entity.DataScopeRoleEntity;
import net.rfs.smartadmin.module.system.department.DepartmentTreeService;
...
import net.rfs.smartadmin.util.SmartBaseEnumUtil;
