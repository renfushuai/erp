    ...
    <div>
        <Card class="smart-query-card">
            ...
            <Row class="smart-query-form-row">
                ...
                <span>
                    销售单号 :
                    <Input placeholder="请输入销售单号" style="width: 180px" v-model="queryForm.orderCode" />
                </span>
                <ButtonGroup>
                    <Button
                            @click="queryList"
                    ...
                    columnArray: [
                        {
                            ...
                            title: '商品Id',
                            key: 'productId',
                            tableColumn: 'erp_sales_order_info.product_id',
                            sortable: 'custom'
                        },
                                                {
                            title: '商品名称',
                            key: 'productName',
                            tableColumn: 'erp_sales_order_info.product_name',
                            sortable: 'custom'
                        },
                                                {
                            title: '货号',
                            key: 'productNumber',
                            tableColumn: 'erp_sales_order_info.product_number',
                            sortable: 'custom'
                        },
                                                {
                            title: '规格',
                            key: 'specifications',
                            tableColumn: 'erp_sales_order_info.specifications',
                            sortable: 'custom'
                        },
                                                {
                            title: '数量',
                            ...
                            title: '出货金额',
                            key: 'salesPrice',
                            tableColumn: 'erp_sales_order_info.sales_price',
                            sortable: 'custom'
                        },
                                                {
                            title: '出货单价',
                            key: 'standardPrice',
                            tableColumn: 'erp_sales_order_info.standard_price',
                            sortable: 'custom'
                        },
                                                {
                            title: '操作',
        ...
        methods: {
            ...
            async batchExport(){
                ...
                try{
                    ...
                    await salesOrderInfoApi.batchExport(this.mainTableSelectArray.map(e => e.id));
                }  catch(e){
                    console.log(e);
                }finally{
