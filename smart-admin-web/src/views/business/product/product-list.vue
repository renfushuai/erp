    ...
    <div>
        <Card class="smart-query-card">
            ...
            <Row class="smart-query-form-row">
                ...
                <span>
                    商品名称 :
                    <Input placeholder="请输入商品名称" style="width: 180px" v-model="queryForm.productName" />
                </span>
                <span>
                    规格 :
                    <Input placeholder="请输入规格" style="width: 180px" v-model="queryForm.specifications" />
                </span>
                <ButtonGroup>
                    <Button
                            @click="queryList"
                            icon="ios-search"
                            type="primary"
                            v-privilege="'product-list-query'"
                    >查询</Button>
                    <Button
        ...
        <Card class="warp-card">
            ...
            <Row class="marginBottom10">
                ...
                <Button
                        ...
                        size="small"
                        type="error"
                        v-privilege="'product-list-batch-delete'"
                >批量删除</Button>
                ...
                <Button
                        ...
                        size="small"
                        type="warning"
                        v-privilege="'product-list-export-all'"
                >导出全部</Button>
                ...
                <Button
                        ...
                        size="small"
                        type="warning"
                        v-privilege="'product-list-batch-export'"
                >批量导出</Button>
...
import ProductListForm from "./components/product-list-form";
      ...
      mainTable: {
        ...
        columnArray: [
          ...
          },
          {
            title: "单价",
            key: "standardPrice",
            tableColumn: "erp_product.standard_price",
            sortable: "custom",
          },
          {
            title: "商品类型",
              ...
              let actions = [
                {
                  ...
                  directives: [
                    {
                      name: "privilege",
                      value: "product-list-update",
                    },
                  ],
                  action: () => {
                    this.showEditProductForm(params.row);
                  },
                },
              ];
  ...
  methods: {
    ...
    async queryList() {
      ...
      try {
        ...
        let result = await productApi.queryProduct(params);
    ...
    async batchDelete() {
      this.$Spin.show();
      await productApi.batchDeleteProduct(
    ...
    async exportAll() {
      try {
        ...
        let params = this.convertQueryParam();
        await productApi.exportAll(params);
      } catch (e) {
        console.log(e);
      } finally {
    ...
    showEditProductForm(updateObject) {
